...
public class QRCodeUtil {
    ...
    public static BufferedImage createImage(String content, URL logoPath, boolean needCompress) throws Exception {
        Hashtable<EncodeHintType, Object> hints = new Hashtable<EncodeHintType, Object>();
        hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H);
        hints.put(EncodeHintType.CHARACTER_SET, CHARSET);
        hints.put(EncodeHintType.MARGIN, 1);
    ...
    private static void insertImage(BufferedImage source, URL logoPath, boolean needCompress) throws IOException {
        InputStream inputStream = logoPath.openStream();
        try {
    ...
    public static void encode(String content, URL logoPath, OutputStream output, boolean needCompress)
            throws Exception {
        BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
        ImageIO.write(image, FORMAT, output);
    }
